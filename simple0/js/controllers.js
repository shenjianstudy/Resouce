...
angular.module('app.controllers', ['pascalprecht.translate', 'ngCookies'])
  ...
  .controller('FlotChartDemoCtrl', ['$scope','$http', function($scope,$http) {
    ...
    //This part is used by ap-nms-manager part start
    $scope.polllistData=[{'ipAddress': "10.56.1.246",
            "macAddress" : "dc53.7c26.b82f",
            "vendorId" : "cbn"   
        }];
    $scope.pollall = function() {
        ...
        var p = $http({
              method: 'PUT',
              url: 'http://172.0.1.165:9090/apmgr/cmts/172.0.1.56/poll?limit=50&vendor=cbn'
          }).then(function(res) {
                console.log("Poll is begin");
              },
              function(error) {
    ...
    $scope.polllist = function() {
          var p = $http({
              method: 'PUT',
              url: 'http://172.0.1.165:9090/apmgr/cmts/172.0.1.56/poll_list',
              data: $scope.polllistData
          }).then(function(res) {
                console.log("Poll is begin");
              },
              function(error) {
